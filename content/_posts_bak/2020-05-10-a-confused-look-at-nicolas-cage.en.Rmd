...
cache_path <- make_cache_path("a-confused-look-at-nicolas-cage-movies")
...
if (file_not_cached(cache_path, cage_credits)) {
  cage_credits <- people_movies("nicolas-cage", extended = "full")
  
  cache_file(cache_path, cage_credits)
} else {
  cage_credits <- read_cache_file(cache_path, cage_credits)
}
