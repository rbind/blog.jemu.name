...
[^rng]: Random number generator; in speedrunning terms it's become synonymous with 'random event' and 'specific outcome of an event determined by [pseudo] random number generation'. I know it's kind of weird to use "rng" as an adjective or catch-all noun, but oh well. Context and such.
