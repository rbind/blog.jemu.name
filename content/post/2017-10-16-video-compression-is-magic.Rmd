...
cache_path <- make_cache_path("video-compression-is-magic")
samples <- read_cache_file(cache_path, samples)
```
...
- **HEVC**: *High Efficiency Video Coding* or *x265*: The new(er) kid on the block and successor to AVC.
